...
def ifandonlyif : Bool -> Bool -> Bool
|false, true => false
|true, false => false
|true, true => true
|false, false => true
...
def newInterp : var → Bool
| c => c.n ≥ 4

#eval eval_expr e0 newInterp
#eval eval_expr e1 newInterp
#eval eval_expr e2 newInterp
#eval eval_expr e3 newInterp
